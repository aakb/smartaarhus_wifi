...
<div class="layout">
  ...
  <div class="form--wrapper">
    <form action="sms-login.php" method="post">
      ...
      <input type="number" placeholder="Enter your mobile number" id="username" autofocus name="username" class="form--input" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required>
